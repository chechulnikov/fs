...
## Дополнительно
За основу архитектуры ФС взята упрощённая архитектура файловой системы [BFS](https://en.wikipedia.org/wiki/Be_File_System), описанная в книге [Practical File System Design](http://www.nobius.org/practical-file-system-design.pdf) за авторством Dominic Giampaolo.